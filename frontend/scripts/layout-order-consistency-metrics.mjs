...
const reportRelativePath = '.tmp/layout-order-consistency-vitest.json'
const reportPath = resolve(projectRoot, reportRelativePath)
...
if (run.error) {
  console.error('[layout-order] failed to start vitest:', run.error)
  process.exit(1)
}
