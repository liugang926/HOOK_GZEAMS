    ...
    <div class="panel-content">
      ...
      >
        ...
        <SectionPropertyEditor
          ...
          :detail-region-options="detailRegionOptions"
          ...
          @update-properties="$emit('sectionPropertyBatchUpdate', $event)"
          @preview-property="$emit('sectionPreviewProperty', $event)"
        />
      </div>
    </div>
  </div>
...
import type { DetailRegionFieldOption } from '@/components/designer/detailRegionFieldOptions'
...
defineEmits<{
  ...
  (e: 'sectionPropertyBatchUpdate', payload: Record<string, unknown>): void
  (e: 'sectionPreviewProperty', payload: { key: string; value: unknown } | { values: Record<string, unknown> } | null): void
}>()
