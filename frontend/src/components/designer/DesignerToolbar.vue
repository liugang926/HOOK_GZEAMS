<template>
  <div class="designer-toolbar">
    ...
    <div class="toolbar-right">
      ...
      <el-button-group>
        <el-tooltip
          :content="t('system.pageLayout.designer.actions.undo') + ' (Ctrl+Z)'"
          placement="bottom"
          :show-after="400"
        >
          <el-button
        ...
        <el-tooltip
          :content="t('system.pageLayout.designer.actions.redo') + ' (Ctrl+Shift+Z)'"
          placement="bottom"
          :show-after="400"
        >
          <el-button
        ...
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item
              ...
              data-testid="layout-translation-mode-item"
            >
            ...
            <el-dropdown-item
              command="reset"
              divided
              data-testid="layout-reset-menu-item"
            >
