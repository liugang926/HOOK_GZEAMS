...
describe('layoutValidation', () => {
  describe('validateLayoutConfig', () => {
    ...
    it('should validate detail-region sections', () => {
      const config = {
        sections: [
          {
            id: 'detail-items',
    ...
    it('should reject invalid section type', () => {
      ...
      const result = validateLayoutConfig(config, 'form')
      expect(result.valid).toBe(false)
      expect(result.errors.some(e => e.path === 'sections[0]')).toBe(true)
    })
  ...
  describe('isLayoutConfigEmpty', () => {
    it('treats detail-region sections as non-empty layout content', () => {
      expect(isLayoutConfigEmpty({
        sections: [
          {
            id: 'detail-items',
            type: 'detail-region',
