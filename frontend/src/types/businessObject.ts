...
export interface BusinessObject {
  ...
  objectRole?: 'root' | 'detail' | 'reference' | 'log'

  /** Whether this object can appear as a top-level menu/page entry */
  isTopLevelNavigable?: boolean

  /** Whether this object supports standalone read/query */
  allowStandaloneQuery?: boolean

  /** Whether this object supports standalone routing */
  allowStandaloneRoute?: boolean

  /** Whether permissions are inherited from a parent aggregate */
  inheritPermissions?: boolean

  /** Whether workflow is inherited from a parent aggregate */
  inheritWorkflow?: boolean

  /** Whether status context is inherited from a parent aggregate */
  inheritStatus?: boolean

  /** Whether lifecycle constraints are inherited from a parent aggregate */
