    ...
    >
      ...
      <div class="page-header">
        <div class="header-left">
          ...
          <h2 class="page-title">
            {{ $t('assets.lifecycle.maintenanceTask.detailTitle') }}
          </h2>
          <el-tag
        ...
        <div class="header-actions">
          ...
          >
            {{ $t('assets.lifecycle.maintenanceTask.actions.verify') }}
          </el-button>
          <el-button
...
onMounted(async () => {
  try {
    ...
    ElMessage.error(t('assets.lifecycle.maintenanceTask.messages.loadFailed'))
  } finally {
    loading.value = false
  }
})
...
const handleExecute = async () => {
  try {
    await maintenanceTaskApi.execute(id, {
      execution_result: executeForm.result,
      actual_hours: executeForm.actualHours
    })
