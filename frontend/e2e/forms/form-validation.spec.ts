...
test.describe('Form Validation', () => {
  ...
  test('should validate email format', async ({ page }) => {
    ...
    const emailInput = page.locator(
      'input[type="email"], input[name*="email"], input[placeholder*="邮箱"], input[placeholder*="邮件"], input[placeholder*="email"]'
    ).first()
  ...
  test('should validate number input ranges', async ({ page }) => {
    ...
    const numberInput = page.locator(
      'input[type="number"], .el-input-number input, input[placeholder*="数量"], input[placeholder*="价格"]'
    ).first()
