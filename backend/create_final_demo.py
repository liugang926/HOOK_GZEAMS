...
Creates remaining business objects: Returns, Loans, Consumables, Maintenance, Inventory, Procurement.

Run with: docker-compose exec -T backend python manage.py shell < create_final_demo.py
"""
import os
import django
...
from apps.assets.models import (
    ...
    AssetReturn, ReturnItem, AssetLoan, LoanItem, Supplier, Location
)
...
# Ensure warehouse location exists
