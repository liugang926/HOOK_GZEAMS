...
class AssetCategoryService(BaseCRUDService):
    ...
    def get_category_path(self, category_id, organization_id=None, user=None):
        """
        ...
        Args:
            ...
            user: Optional acting user for organization validation
        ...
        while current:
            ...
            current = self.model_class.all_objects.filter(
