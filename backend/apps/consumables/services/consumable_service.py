...
class ConsumableService(BaseCRUDService):
    ...
    def get_stock_transactions(self, consumable_id: str, organization_id: str = None, user=None):
        """Get stock transactions for a consumable."""
        return self._scope_queryset(
            ConsumableStock.all_objects.filter(
    ...
    def adjust_stock(self, consumable_id: str, quantity: int,
        ...
        Args:
            ...
            quantity: Quantity change (positive for add, negative for reduce)
            transaction_type: Type of transaction
            user: User performing the adjustment
            organization_id: Explicit organization scope
...
class ConsumablePurchaseService(BaseCRUDService):
    ...
    def create_with_items(self, data: dict, user, organization_id: str = None):
        """
        ...
        if not resolved_org_id:
            raise ValidationError({'organization_id': 'Organization context is required'})
    ...
    def submit_for_approval(self, purchase_id: str, user=None, organization_id: str = None):
        """
    ...
    def receive(self, purchase_id: str, user, organization_id: str = None):
        """
    ...
    def complete(self, purchase_id: str, user=None, organization_id: str = None):
        """
    ...
    def cancel(self, purchase_id: str, reason: str = '', user=None, organization_id: str = None):
        """
...
class ConsumableIssueService(BaseCRUDService):
    ...
    def create_with_items(self, data: dict, user, organization_id: str = None):
        ...
        for item_data in items_data:
            consumable_id = item_data['consumable_id']
            try:
                consumable = Consumable.all_objects.get(
                    id=consumable_id,
                    organization_id=resolved_org_id,
                    is_deleted=False,
                )
            ...
            item_data['organization_id'] = resolved_org_id
    ...
    def submit_for_approval(self, issue_id: str, user=None, organization_id: str = None):
        """
    ...
    def issue(self, issue_id: str, user, organization_id: str = None):
        """
    ...
    def complete(self, issue_id: str, user=None, organization_id: str = None):
        """
    ...
    def cancel(self, issue_id: str, reason: str = '', user=None, organization_id: str = None):
        """
