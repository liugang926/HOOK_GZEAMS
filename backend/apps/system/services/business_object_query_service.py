            ...
            result.append(
                {
                    ...
                    "type": "hardcoded",
                    "menu_category": obj.menu_category if obj else definition.menu_category,
                    "is_menu_hidden": obj.is_menu_hidden if obj else definition.is_menu_hidden,
                    "object_role": obj.object_role if obj else definition.object_role,
                    "is_top_level_navigable": (
                        obj.is_top_level_navigable
                        if obj is not None
                        else definition.is_top_level_navigable
                    ),
                    "allow_standalone_query": (
                        obj.allow_standalone_query
                        if obj is not None
                        else definition.allow_standalone_query
                    ),
                    "allow_standalone_route": (
                        obj.allow_standalone_route
                        if obj is not None
                        else definition.allow_standalone_route
                    ),
                    "inherit_permissions": (
                        obj.inherit_permissions
                        if obj is not None
                        else definition.inherit_permissions
                    ),
                    "inherit_workflow": (
                        obj.inherit_workflow
                        if obj is not None
                        else definition.inherit_workflow
                    ),
                    "inherit_status": (
                        obj.inherit_status
                        if obj is not None
                        else definition.inherit_status
                    ),
                    "inherit_lifecycle": (
                        obj.inherit_lifecycle
                        if obj is not None
                        else definition.inherit_lifecycle
                    ),
                }
            )
        ...
        return [
            {
                ...
                "is_menu_hidden": obj.is_menu_hidden,
                "object_role": obj.object_role,
                "is_top_level_navigable": obj.is_top_level_navigable,
                "allow_standalone_query": obj.allow_standalone_query,
                "allow_standalone_route": obj.allow_standalone_route,
                "inherit_permissions": obj.inherit_permissions,
                "inherit_workflow": obj.inherit_workflow,
                "inherit_status": obj.inherit_status,
                "inherit_lifecycle": obj.inherit_lifecycle,
            }
            for obj in queryset
        ]
