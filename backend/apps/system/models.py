...
class ObjectRelationDefinition(BaseModel):
    ...
    DETAIL_EDIT_MODE_CHOICES = [
        ('inline_table', _('Inline Table')),
        ('nested_form', _('Nested Form')),
        ('readonly_table', _('Readonly Table')),
    ]
    ...
    detail_edit_mode = models.CharField(
        max_length=20,
        choices=DETAIL_EDIT_MODE_CHOICES,
