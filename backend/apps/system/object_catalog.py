...
HARDCODED_OBJECTS: Tuple[HardcodedObjectDefinition, ...] = (
    ...
    HardcodedObjectDefinition(
        code="TagGroup",
        name="资产标签组",
        name_en="Asset Tag Group",
        django_model_path="apps.assets.models.TagGroup",
        viewset_path="apps.assets.viewsets.TagGroupViewSet",
        icon="collection",
    ),
    HardcodedObjectDefinition(
        code="AssetTag",
        name="资产标签",
        name_en="Asset Tag",
        django_model_path="apps.assets.models.AssetTag",
        viewset_path="apps.assets.viewsets.AssetTagViewSet",
        icon="price-tag",
    ),
    HardcodedObjectDefinition(
        code="AssetCategory",
    ...
    HardcodedObjectDefinition(
        ...
        name="盘点跟进",
        name_en="Inventory Follow-up",
        django_model_path="apps.inventory.models.InventoryFollowUp",
        viewset_path="apps.inventory.viewsets.InventoryFollowUpViewSet",
        icon="bell",
        is_menu_hidden=True,
        object_role="detail",
        is_top_level_navigable=False,
    ...
    HardcodedObjectDefinition(
        ...
        viewset_path="apps.inventory.viewsets.InventoryReconciliationViewSet",
    ...
    HardcodedObjectDefinition(
        ...
        viewset_path="apps.inventory.viewsets.InventoryReportViewSet",
        icon="data-analysis",
        is_menu_hidden=True,
    ),
    HardcodedObjectDefinition(
