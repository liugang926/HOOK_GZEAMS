...
urlpatterns = [
    ...
    path('objects/<str:code>/document/', ObjectRouterViewSet.as_view({'post': 'document_create'}), name='object-router-document-create'),
    ...
    path(
        ...
        ObjectRouterViewSet.as_view({
            'get': 'document',
            'put': 'document_update',
            'patch': 'document_partial_update',
        }),
        name='object-router-document-detail',
    ),
    ...
    path('objects/<str:code>/<uuid:id>/actions/', ObjectRouterViewSet.as_view({'get': 'actions'}), name='object-router-actions'),
    path(
        'objects/<str:code>/<uuid:id>/actions/<path:action_code>/execute/',
        ObjectRouterViewSet.as_view({'post': 'execute_action'}),
        name='object-router-execute-action',
    ),
