...
class TestPaginationConsistency:
    ...
    def test_deleted_endpoint_pagination_format(self, auth_client, asset):
        ...
        url = reverse('assets:asset-deleted')
    ...
    def test_pagination_with_page_size(self, auth_client, organization, asset_category):
    ...
    def test_pagination_page_parameter(self, auth_client, organization, asset_category):
