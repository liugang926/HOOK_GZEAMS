...
class TestIsOrganizationMember:
    ...
    def test_allows_legacy_default_organization(self, db, organization):
        """Legacy users with only a default organization should be materialized as members."""
        from django.contrib.auth import get_user_model
        from apps.common.permissions.base import IsOrganizationMember

        user = get_user_model().objects.create_user(
            username='legacy-permission-user',
            email='legacy-permission@example.com',
