...
class BaseOrganizationService:
    ...
    def check_organization_access(
        ...
        target_org_id = normalize_organization_id(target_org_id)
        ...
        try:
            ...
            if normalize_organization_id(default_organization.id) != target_org_id:
                return False
    ...
    def get_user_accessible_organizations(user) -> List[dict]:
        ...
        try:
            ...
            user.ensure_default_organization()
