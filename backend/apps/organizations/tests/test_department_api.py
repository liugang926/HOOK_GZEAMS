...
class TestDepartmentViewSet:
    ...
    def test_path_endpoint_nested(self, auth_client, organization):
        ...
        assert data['data'][0]['fullPathName'] == 'Headquarters'
        assert data['data'][1]['fullPathName'] == 'Headquarters/IT Department'
        assert data['data'][2]['fullPathName'] == 'Headquarters/IT Department/Development Team'
