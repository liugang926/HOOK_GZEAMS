...
Run with: docker-compose exec -T backend python manage.py shell < create_remaining_final_v4.py
"""
import os
import django
...
print(f"Found {len(departments)} departments, {len(demo_users)} demo users")
